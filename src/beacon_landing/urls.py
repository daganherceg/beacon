...
urlpatterns = [
  ...
  url(r'^quest', 'signups.views.quest', name='quest'),
  url(r'^whoareyou', 'signups.views.whoareyou', name='whoareyou'),
  url(r'^postquest', 'signups.views.postquest', name='postquest'),
